...
<div class="row">
<div class="col-lg-6">
<span class="logo">CSU/CICS-QES</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter your name (Last name, First name)" class="form-control input-md" type="text">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your department name" class="form-control input-md" type="text">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">The Developer</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://www.facebook.com/iaaane" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ian Estabillo</a>
		...
		<h4 style="font-family:'typo' ">Owner/Proprietor at RIESOLUTIONS</h4></div></div>
		</p>
      </div>
