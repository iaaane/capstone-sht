...
<div class="col-lg-6">
<span class="logo">CICS-QES</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<h2 align="center" style="font-family:'typo'; color:#000066">ABOUT THE SYSTEM</h2>

<div style="font-size:20px">
This system is a system project developed by Ian Estabillo as a requirement for the CAPSTONE project. The CAPSTONE project is a requirement and is under the curriculum of Information Technology course in Cagayan State University at Sanchez Mira, Cagayan.	This system lets students take their examination via interconnected computer units on a local area network with an admin supervising the activity. <br/><br/>The primary objectives of this system is to reduce human error on computing and recording tests, save time on checking papers and encourages green living by reducing the use of papers that uses trees to produce it.
...
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers">The Developer</a>
